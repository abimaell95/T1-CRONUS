...
class OrderView(generics.ListCreateAPIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response({
                        "data": [],
                        "message": "Error creating the event record." + str(ex)
        ...
        try:
            ...
            return Response({
                        "data": [],
                        "message": "Error creating the order record." + str(ex)
                    }, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
        ...
        try:
            ...
            return Response({
                        "data": [],
                        "message": "Error creating the record." + str(ex)
            }, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
...
def available_hours(request):
    ...
    if request.method == "GET":
        ...
        if branch is None:
            return JsonResponse({
                        "data": [],
                        "message": "No branch value. \
                        A BranchOffice is needed for this transaction.",
