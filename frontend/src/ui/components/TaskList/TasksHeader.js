...
function TasksHeader({selectedView, selectedDate, setSelectedDate, setOpenCreateEvent}){
    return(
        <>
         <header className="">
            <div className="flex flex-row px-4 pt-4 justify-center border-b border-gray-200">
                <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                    <Link to="/tasks" class={selectedView ==0 ? "border-gray-500 text-gray-600 group inline-flex items-center pb-2 px-1 border-b-2 font-medium text-sm" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 group inline-flex items-center pb-2 px-1 border-b-2 font-medium text-sm"}>
                    ...
                    <Link to="/calendar" class={selectedView == 1 ? "border-gray-500 text-gray-600 group inline-flex items-center pb-2 px-1 border-b-2 font-medium text-sm" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 group inline-flex items-center pb-2 px-1 border-b-2 font-medium text-sm"}>
